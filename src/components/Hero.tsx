      ...
      <div className="container">
        ...
        <div className="hero-cta-container">
          ...
          <div className="hero-socials">
            <a href="https://github.com/Michaelndula" target="_blank" rel="noopener noreferrer" className="social-btn social-github" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/michael-ndula-bb57ab1b4/" target="_blank" rel="noopener noreferrer" className="social-btn social-linkedin" aria-label="LinkedIn">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
